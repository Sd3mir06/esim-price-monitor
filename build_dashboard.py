...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .deals{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:9px;margin:2px 0 14px}
  @media(max-width:760px){.deals{grid-template-columns:repeat(2,minmax(0,1fr))}}
  ...
  .deal .dhead{display:flex;flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:1px 8px;margin-bottom:6px}
  .deal .ds{flex:1 0 auto}
